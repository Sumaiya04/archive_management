...
// Check connection
    ...
    INNER JOIN tbl_role ON tbl_user_role.RoleID=tbl_role.ID WHERE tbl_role.Name='Teacher'
    AND tbl_user.Email NOT IN (SELECT tms_supervisor_publication.supervisor_id FROM tms_supervisor_publication WHERE 
    tms_supervisor_publication.publication_id='".$PId."') AND tbl_user.Email LIKE '%$Key%'";
