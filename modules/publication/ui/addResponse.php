...
// Check connection
    ...
    AND tbl_user.Email NOT IN (SELECT tms_student_publication.student_id FROM tms_student_publication WHERE 
    tms_student_publication.publication_id='".$PId."') AND tbl_user.Email LIKE '%$Key%'";
