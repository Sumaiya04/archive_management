<?php
include_once 'blade/view.searchPublication.blade.php';
    ...
    <div class="col-md-9">
        <div class="panel panel-default myPanel">
            ...
            <div class="panel-heading myHeading">
                <strong><img src="./resources/img/searchProject.png" alt="Icon" class="myImg">&nbsp;Search Publication</strong>
            </div>
                    ...
                    <div id="divteacher" class="form-group" hidden>
                        ...
                        <div class="col-md-7">
                            <select name="teacher_id" id="teacher_id" class="form-control" required>
                                ...
                                <?php
                                $Result=$_PublicationBao->getAllTeachers();
                                if ($Result->getIsSuccess()){
                    ...
                    <div id="divmember" class="form-group" hidden>
                        ...
                        <div class="col-md-7">
                            <select name="member_id" id="member_id" class="form-control" required>
                                ...
                                <?php
                                $Result=$_SearchPublicationBao->getAllStudents();
                                if ($Result->getIsSuccess()){
...
if (isset($_POST['search'])&&(!empty($_POST['title'])||!empty($_POST['language'])||!empty($_POST['year_id'])||!empty($_POST['term_id'])
    ...
    <div class="panel panel-table">
        <table class="table table-striped table-bordered table-responsive">
            ...
            <!--Table Cells-->
            <?php
            $Result=$_SearchPublicationBao->getSearchedPublication();
            if($Result->getIsSuccess()){
                ...
                foreach ($PublicationList as $publication) {
                    ...
                    <tr>
                        ...
                        <td class="table-cell"><a href="<?php echo $publication->getPublicationPDFLink(); ?>" style="text-decoration: none"><?php
