<?php
include_once 'blade/view.publicationMember.blade.php';
...
<div class="container">
    ...
    <div class="panel panel-default myPanel">
        <div class="panel-heading myHeading" style="margin-bottom: 0vh">
            <strong><img src="<?php
                $Publication->setPublicationId($_GET['id']);
                $Result=$_PublicationBao->getPublication($Publication)->getResultObject();
                echo $Result->getPublicationThumbnail();?>" alt="Icon" class="myImg">&nbsp;<?php
                echo $Result->getPublicationTitle()?></strong>
        </div>
            ...
            <div class="form-horizontal">
                ...
                <div id="shortDescription" class="form-group">
                    ...
                    <div id="description" class=" control-label col-md-8 text-justify">
                        <?php
                        if(strlen($Result->getPublicationDescription())>250){
                            echo substr($Result->getPublicationDescription(),0,250).'...'.'<a href="#" onclick="rmFunction();">Read more</a>';
                        }
                        else{
                            echo $Result->getPublicationDescription();
                        }
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="link" class="control-label col-md-8 text-justify">
                        <?php
                        $LinkList=$_MemberBao->getLink($Publication)->getResultObject();
                        if ($LinkList!=null) {
                            foreach ($LinkList as $link) {
                                ...
                                if (isset($_SESSION['login.php'])) {
                                    ?>
                                    <a href="?id=<?php echo $Result->getPublicationId(); ?>&rlid=<?php echo $link->getLinkPublicationId(); ?>"
                ...
                <div class="form-group">
                    ...
                    <div id="link" class="control-label col-md-8 text-justify">
                        <?php
                        echo '<a href="'.$Result->getPublicationPDFLink().'">'.$Result->getPublicationTitle().'.pdf'.'</a>';
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="year_id" class="control-label col-md-8 text-justify">
                        <?php
                        echo $_PublicationBao->getYear($Result->getPublicationYearId())->getResultObject()->getYearName();
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="term_id" class="control-label col-md-8 text-justify">
                        <?php
                        echo $_PublicationBao->getTerm($Result->getPublicationTermId())->getResultObject()->getTermName();
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="course_id" class="control-label col-md-8 text-justify">
                        <?php
                        echo $_PublicationBao->getCourse($Result->getPublicationCourseId())->getResultObject()->getCourseTitle();
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="discipline_id" class="control-label col-md-8 text-justify">
                        <?php
                        echo $_PublicationBao->getDiscipline($Result->getPublicationDisciplineId())->getResultObject()->getDisciplineName();
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="supervisor" class="control-label col-md-8 text-justify">
                        <?php
                        $SupervisorList=$_MemberBao->getSupervisor($Publication)->getResultObject();
                            ...
                            foreach ($SupervisorList as $supervisor) {
                                ...
                                <div class="col-md-6"><?php $Name = $_MemberBao->getTeacher($supervisor->getSupervisorId())->getResultObject();
                                    ...
                                    if (isset($_SESSION['login.php'])) {
                                        ?>
                                        <ul class="col-md-5">
                                            <a href="?id=<?php echo $Result->getPublicationId(); ?>&ruid2=<?php echo $Name->getEmail(); ?>"
                                               class="remove-icon" onclick="return confirm('sure to remove !!');">
                ...
                <div class="form-group">
                    ...
                    <div id="created_at" class="control-label col-md-8 text-justify">
                        <?php
                        echo date_format(new DateTime($Result->getPublicationCreatedAt()),"d-M-Y").' '.'at'.' '.date_format(new DateTime($Result->getPublicationCreatedAt()),"h:i:sa");
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="updated_at" class="control-label col-md-8 text-justify">
                        <?php
                        echo date_format(new DateTime($Result->getPublicationUpdatedAt()),"d-M-Y").' '.'at'.' '.date_format(new DateTime($Result->getPublicationUpdatedAt()),"h:i:sa");
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div id="member" class="control-label col-md-8 text-justify">
                        <?php
                        $MemberList=$_MemberBao->getMember($Publication)->getResultObject();
                        if ($MemberList!=null) {
                            $i=0;
                    ...
                    <tr class="table-cell">
                        ...
                        <td>
                            <input type="hidden" name="publicationId" id="publicationId"
                                   value="<?php echo $Result->getPublicationId(); ?> ">
                        ...
                        <td><a class="span-danger"
                                    href="?id=<?php echo $Result->getPublicationId(); ?>&ruid=<?php echo $Name->getEmail(); ?>"
...
<script>
    ...
    function addStudentFunction(emailStr) {
        ...
        xmlhttp.open("GET","./modules/publication/ui/addResponse.php?key="+emailStr+"&pid="+val,true);
        xmlhttp.send();
    }
    ...
    function addSupervisorFunction(emailStr) {
        ...
        xmlhttp.open("GET","./modules/publication/ui/addResponse2.php?key="+emailStr+"&pid="+val,true);
        xmlhttp.send();
    }
    ...
    function updateFunction(element) {
        ...
        xhttp.open("GET","./modules/publication/ui/contribution.php?pid="+publicationId+"&uid="+userId+"&conval="+contribution,true);
        xhttp.send();
    }
</script>