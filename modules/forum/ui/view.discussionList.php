...
<div class="panel panel-default myPanel">
    ...
    <div class="panel-heading myHeading" style="background-color: rgba(0,102,106,0.66); color: white">
        <strong><img src="./resources/img/allDiscussion.png" alt="Icon" class="myImg">&nbsp;All the Discussions</div>
	...
	?> 
		<tr style="background-color: rgba(0,102,106,0.66); color: white">
			<th>Questions</th>
			<th>Category</th>
			<th>Tags</th>
		</tr>
...
<div class="panel panel-default myPanel">
    ...
    <div class="panel-body">
		...
		<table class="table table-striped table-bordered"">
			<tr style="background-color: rgba(0,102,106,0.66); color: white"><th>Category</th></tr>
			<tr><?php
